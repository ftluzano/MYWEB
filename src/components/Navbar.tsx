    ...
    <header className="w-full bg-[#08080c]/95 backdrop-blur-md border-b border-red-950/40 py-3 sm:py-3.5 pt-safe select-none sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8 flex items-center justify-center">
        ...
        <div className="flex items-center gap-2.5 sm:gap-3 group cursor-pointer">
          ...
          <div className="relative w-8 h-8 sm:w-10 sm:h-10 rounded-xl overflow-hidden bg-black border border-red-700/80 shadow-[0_0_16px_rgba(220,38,38,0.45)] group-hover:border-red-500 group-hover:shadow-[0_0_24px_rgba(239,68,68,0.7)] transition-all shrink-0">
            <img
              src={kyleLogo}
          ...
          <span
            ...
            className="font-graffiti text-xl sm:text-2xl md:text-3xl font-bold tracking-[0.10em] sm:tracking-[0.14em] text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-rose-100 to-red-500 drop-shadow-[0_0_14px_rgba(239,68,68,0.7)] group-hover:drop-shadow-[0_0_22px_rgba(239,68,68,0.95)] transition-all select-none leading-none pt-0.5 whitespace-nowrap"
            title="KYLE DOMAIN"
          >
            KYLE DOMAIN
          </span>
